    ...
    <main className="min-h-screen pt-24 pb-16 bg-background-main">
      <div className="container mx-auto px-4 md:px-6 max-w-5xl">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-primary mb-6">{t("info.title")}</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100 flex flex-col items-start">
            ...
            <h2 className="text-2xl font-bold text-primary mb-4">{t("info.fleetTitle")}</h2>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100 flex flex-col items-start">
            ...
            <h2 className="text-2xl font-bold text-primary mb-4">{t("info.systemTitle")}</h2>
        ...
        <div className="bg-primary text-white rounded-3xl shadow-xl overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="p-8 md:p-12">
              <h2 className="text-3xl font-bold mb-8">{t("info.contactTitle")}</h2>
              <ul className="space-y-6">
                <li className="flex items-start gap-4">
                  <MapPin className="text-action mt-1" size={24} />
                  <div>
                    <strong className="block text-lg mb-1">{t("info.officeTitle")}</strong>
                ...
                <li className="flex items-center gap-4">
                  ...
                  <div>
                    <strong className="block text-lg mb-1">{t("info.phoneTitle")}</strong>
            ...
            <div className="bg-blue-900 p-8 md:p-12 flex flex-col justify-center">
              ...
              <ul className="space-y-4">
                <li className="flex justify-between items-center border-b border-blue-800 pb-2">
                  <span className="text-blue-200">{t("info.weekdays")}</span>
                  <span className="font-semibold">08:00 - 18:00</span>
                </li>
                <li className="flex justify-between items-center border-b border-blue-800 pb-2">
                  <span className="text-blue-200">{t("info.saturday")}</span>
                  <span className="font-semibold">09:00 - 15:00</span>
                </li>
                <li className="flex justify-between items-center pb-2">
                  <span className="text-blue-200">{t("info.sundays")}</span>
                  <span className="font-semibold text-action">{t("info.closed")}</span>
                </li>
              </ul>
            </div>
          </div>
